...
| `ctx.desktopRuntime` | `bundle` | [`desktop-app`](../packages/bundle/desktop-app) | - | - | - | Marks the settled desktop Host with no bind address; the Electron shell reads the client graph this Host already composes. |
