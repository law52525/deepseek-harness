...
The dsh-base bundle patch every profile applies first; mode bundles (dsh-web-app, dsh-desktop-app, dsh-headless) and the user's profile layer patch over it.
